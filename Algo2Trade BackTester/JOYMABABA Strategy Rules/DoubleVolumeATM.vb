...
Public Class DoubleVolumeATM
    ...
    Private ReadOnly _VolumeMultiplier As Decimal = 2
                ...
                For Each runningPayload In _inputPayload.Keys
                    ...
                    If runningPayload.Date = _tradingDate.Date Then
                        ...
                        If potentialHighEntryPrice = 0 AndAlso potentialLowEntryPrice = 0 AndAlso levelPrice = 0 Then
                            If _inputPayload(runningPayload).PreviousCandlePayload.PreviousCandlePayload.PayloadDate.Date = _tradingDate.Date AndAlso
                                _inputPayload(runningPayload).PreviousCandlePayload.Volume >= _VolumeMultiplier * _inputPayload(runningPayload).PreviousCandlePayload.PreviousCandlePayload.Volume Then
