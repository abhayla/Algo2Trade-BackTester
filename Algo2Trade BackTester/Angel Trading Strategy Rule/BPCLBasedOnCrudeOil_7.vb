...
Public Class BPCLBasedOnCrudeOil_7
    ...
    Public Overrides Sub CalculateRule(ByRef outputPayload As Dictionary(Of String, Object))
        If _inputPayload IsNot Nothing AndAlso _inputPayload.Count > 0 Then
            ...
            If _inputPayload.LastOrDefault.Key.Date = _tradingDate.Date Then
                ...
                Dim previousTradingDay As Date = _cmn.GetPreviousTradingDay(Common.DataBaseTable.EOD_Commodity, "CRUDEOIL", _tradingDate)
                Dim eodPayload As Dictionary(Of Date, Payload) = _cmn.GetRawPayload(Common.DataBaseTable.EOD_Commodity, "CRUDEOIL", previousTradingDay, previousTradingDay)
