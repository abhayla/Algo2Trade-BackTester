...
Namespace Calculator
    Public Class Brokerage_Calculator
...
#Region "Public Fuctioncs"
        Public Function Intraday_Equity(ByVal Buy As Double, ByVal Sell As Double, ByVal Quantity As Integer, ByRef Output As Output_Brokerage_Calculator)
        ...
        Public Function Delivery_Equity(ByVal Buy As Double, ByVal Sell As Double, ByVal Quantity As Integer, ByRef Output As Output_Brokerage_Calculator)
        ...
        Public Function FO_Futures(ByVal Buy As Double, ByVal Sell As Double, ByVal Quantity As Integer, ByRef Output As Output_Brokerage_Calculator)
        ...
        Public Function Commodity_MCX(ByVal item As String, ByVal Buy As Double, ByVal Sell As Double, ByVal Quantity As Integer, ByRef Output As Output_Brokerage_Calculator) As Task
